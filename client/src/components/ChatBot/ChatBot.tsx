  ...
  const responses: KeyResponse = [
    {
      keywords: ["массив"],
      response:
        "Если вы хотите придать древесине цвет, вам нужно выбрать 3 компонента: морилка, грунт и лак. Если такой необходимости нет, то используйте грунт и лак.",
    },
    {
      keywords: ["мдф"],
      response:
        "Если вы хотите придать поверхности эффект старения или изменения оттенка, вам необходимо будет выбрать 6 компонентов: грунт-изолятор, заполняющий грунт, краску, акриловый грунт, патину и лак. Если такой необходимости нет, то нужно выбрать 3 компонента: грунт-изолятор, заполняющий грунт и краску.",
    },
    {
      keywords: ["морилка"],
      response:
    ...
    },
    {
      keywords: ["акриловый"],
      response:
        "Акриловый грунт – это материал или покрытие на основе акрила, обычно обладающее хорошей стойкостью и эластичностью.",
    },
    {
      keywords: ["патина"],
      response:
    ...
    },
    {
      ...
      response:
        "Какой материал вы хотите использовать для покраски? МДФ или Массив?",
    },
    {
    ...
    { keywords: ["адрес", "адреса"], response: "Укажите ваш город." },
    {
      keywords: ["адрес", "адреса"],
      response: "Вот список филиалов, находящихся в вашем городе:",
    },
  ];
